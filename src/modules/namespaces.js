...
export const DLDIST = namespace('https://concepts.datalad.org/s/distribution/unreleased/');
export const DLTHING = namespace('https://concepts.datalad.org/s/thing/unreleased/');
export const DLTHINGS = namespace('https://concepts.datalad.org/s/things/v1/');
export const DLTYPES = namespace('https://concepts.datalad.org/s/types/unreleased/');
